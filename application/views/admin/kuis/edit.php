...
<div class="container-fluid">
  ...
  <div class="row">
      <div class="col-lg-12">
          <div class="card">
              <div class="card-body">
                <form action="<?= base_url('admin/kuis/edit/') . $kuis->id_soal; ?>" method="post">
                <div class="form-group">
                    <label><strong>Soal</strong></label>
                    <?= form_error('soal','<small class="text-danger">','</small>'); ?>
                    <textarea name="soal" id="soal" cols="30" rows="10" required><?= $kuis->soal; ?></textarea>
                </div>
...
<div class="form-group">
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td><textarea name="A" id="opsi_a" cols="30" rows="5"><?= $kuis->opsi_a; ?></textarea></td>
        </tr>
        <tr>
            <th>Opsi B <br><?= form_error('B','<small class="text-danger">','</small>'); ?></th>
            <td><textarea name="B" id="opsi_b" cols="30" rows="5"><?= $kuis->opsi_b; ?></textarea></td>
        </tr>
        <tr>
            <th>Opsi C <br><?= form_error('C','<small class="text-danger">','</small>'); ?></th>
            <td><textarea name="C" id="opsi_c" cols="30" rows="5"><?= $kuis->opsi_c; ?></textarea></td>
        </tr>
        <tr>
            <th>Opsi D <br><?= form_error('D','<small class="text-danger">','</small>'); ?></th>
            <td><textarea name="D" id="opsi_d" cols="30" rows="5"><?= $kuis->opsi_d; ?></textarea></td>
        </tr>
        <tr>
            <th>Opsi E <br><?= form_error('E','<small class="text-danger">','</small>'); ?></th>
            <td><textarea name="E" id="opsi_e" cols="30" rows="5"><?= $kuis->opsi_e; ?></textarea></td>
        </tr>
    </table>
</div>
                ...
                <div class="form-group">
                    ...
                    <select name="jawaban" class="form-control" required>
                        ...
                        <?php $opsi = ['A','B','C','D','E']; foreach($opsi as $o){ ?>
                            <?php if($kuis->kunci_jawaban == $o){ ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="skor" class="form-control" value="<?= $kuis->skor_soal; ?>" required>
                </div>

                <div class="form-group">
                    <label><strong>Penjelasan Jawaban</strong></label>
                    <?= form_error('penjelasan','<small class="text-danger">','</small>'); ?>
                    <textarea name="penjelasan" id="penjelasan" cols="30" rows="10"><?= $kuis->penjelasan; ?></textarea>
                </div>
